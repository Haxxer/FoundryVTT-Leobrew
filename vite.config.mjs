...
// ATTENTION!
// You must change `base` and the `proxy` strings replacing `/systems/leobrew/` with your
// module or system ID.
...
export default () => {
  ...
  return {
    ...
    base: '/systems/leobrew/',   // Base module path that 30001 / served dev directory.
    ...
    server: {
      ...
      open: false,
      proxy: {
        '^(/systems/leobrew/languages)': 'http://127.0.0.1:30000',
        '^(?!/systems/leobrew/)': 'http://127.0.0.1:30000',
